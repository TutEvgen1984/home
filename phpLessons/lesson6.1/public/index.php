...
<body>
    ...
    // Выполните код ниже и посмотрите какой получится результат. Так можно создавать строки из отдельных байтов.
    $str4 = chr(240) . chr(159) . chr(144) . chr(152);
    echo $str4;
    // 🐘
    // что интересно, нормальный слоник появляется только если 4 значка последовательно. Если вывести только один или 2 или только три, то получим непонятный значок с вопросом �, видимо это связано с 4 байтами как то

    // А теперь попробуйте обратные действия.

    // declare(encoding='UTF-8');
    $str5 = "🐘";
    echo "<br>";
    for ($pos = 0; $pos < strlen($str5); $pos++) {
        $byte = substr($str5, $pos);
        echo 'Байт ' . $pos . ' строки $str5 равен ' . ord($byte) . "<br>";
    }
    // 🐘
    // Байт 0 строки $str5 равен 240
    // Байт 1 строки $str5 равен 159
    // Байт 2 строки $str5 равен 144
    // Байт 3 строки $str5 равен 152
